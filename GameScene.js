  ...
  create() {
    ...
    for (let i = 1; i < 10; i++) {
      ...
      // Adds the code for tweens:
        ...
        } // ends onComplete tween function
      });

      // provide visual feedback on wrong choice
